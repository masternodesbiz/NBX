Contributing to Netbox.Wallet
============================

Netbox.Wallet project operates an open contributor model where anyone is
...
The following applies to code changes to Netbox.Wallet project, and is not to be
confused with overall NBX network Protocol consensus changes.

Whether a pull request is merged into Netbox.Wallet rests with the project merge
...
Where a patchset proposes to change the consensus, it must have been
...
The project leader is the release manager for each Netbox.Wallet release.
