...
#define QAPP_ORG_NAME "NetboxWallet"
#define QAPP_ORG_DOMAIN "netbox.global"
#define QAPP_APP_NAME_DEFAULT "NetboxWallet-Qt"
#define QAPP_APP_NAME_TESTNET "NetboxWallet-Qt-testnet"
