                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Netbox.Wallet") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About Netbox.Wallet"));
        ...
        QString header = tr("Usage:") + "\n" +
                         "  netboxwallet [" + tr("command-line options") + "]                     " + "\n";
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Netbox.Wallet is shutting down...") + "<br /><br />" +
...
{
    if (!window || GetBoolArg("-hide", false))
        return;
