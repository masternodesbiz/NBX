...
static const struct {
    ...
    {"test", QAPP_APP_NAME_TESTNET, ":/icons/nbx_testnet", QT_TRANSLATE_NOOP("SplashScreen", "[testnet]"), ":/images/splash_testnet"},
    {"regtest", QAPP_APP_NAME_TESTNET, ":/icons/nbx_regtest", "[regtest]", ":/images/splash_regtest"}};
