...
extern UniValue getreservedaddress(const UniValue& params, bool fHelp);
...
extern UniValue getxpub(const UniValue& params, bool fHelp);
extern UniValue getfirstaddress(const UniValue& params, bool fHelp);
