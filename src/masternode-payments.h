...
public:
    ...
    bool IsTransactionValid(const CTransaction& txNew, CAmount prevMoneySupply);
...
public:
    ...
    bool IsTransactionValid(const CTransaction& txNew, int nBlockHeight, CAmount prevMoneySupply);
