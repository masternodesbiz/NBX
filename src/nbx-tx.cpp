...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Netbox.Wallet nbx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nbx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nbx transaction") + "\n" +
                               "  nbx-tx [options] -create [commands]   " + _("Create hex-encoded nbx transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nbx transaction
