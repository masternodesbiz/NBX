...
RESOURCES += src/qt/nbx.qrc src/qt/nbx_locale.qrc

TRANSLATIONS += src/qt/locale/nbx_bg.ts \
                src/qt/locale/nbx_de.ts \
                src/qt/locale/nbx_en.ts \
                src/qt/locale/nbx_es.ts \
                src/qt/locale/nbx_fi.ts \
                src/qt/locale/nbx_fr.ts \
                src/qt/locale/nbx_it.ts \
                src/qt/locale/nbx_ja.ts \
                src/qt/locale/nbx_pl.ts \
                src/qt/locale/nbx_pt.ts \
                src/qt/locale/nbx_ru.ts \
                src/qt/locale/nbx_sk.ts \
                src/qt/locale/nbx_sv.ts \
                src/qt/locale/nbx_vi.ts \
                src/qt/locale/nbx_zh_CN.ts \
                src/qt/locale/nbx_zh_TW.ts
